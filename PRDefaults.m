...
- (id)init {
    ...
    [_handlers setValue:[PRDefaults boolHandlersForKey:@"useCompilation" defaultValue:YES] forKey:PRDefaultsUseCompilation];
    [_handlers setValue:[PRDefaults boolHandlersForKey:@"folderArtwork" defaultValue:YES] forKey:PRDefaultsFolderArtwork];

    [_handlers setValue:[PRDefaults boolHandlersForKey:@"postGrowlNotification" defaultValue:YES] forKey:PRDefaultsPostGrowl];

    [_handlers setValue:[PRDefaults stringHandlersForKey:@"lastFMUsername" defaultValue:@""] forKey:PRDefaultsLastFMUsername];

    [_handlers setValue:[PRDefaults boolHandlersForKey:@"showsWelcomeSheet" defaultValue:YES] forKey:PRDefaultsShowWelcomeSheet];
    [_handlers setValue:[PRDefaults boolHandlersForKey:@"showsArtwork" defaultValue:YES] forKey:PRDefaultsShowArtwork];
    [_handlers setValue:[PRDefaults boolHandlersForKey:@"miniPlayer" defaultValue:NO] forKey:PRDefaultsMiniPlayer];
    [_handlers setValue:[PRDefaults rectHandlersForKey:@"miniPlayerFrame" defaultValue:NSZeroRect] forKey:PRDefaultsMiniPlayerFrame];
    [_handlers setValue:[PRDefaults rectHandlersForKey:@"playerFrame" defaultValue:NSZeroRect] forKey:PRDefaultsPlayerFrame];
    [_handlers setValue:[PRDefaults archiverHandlersForKey:@"nowPlayingCollapseState" class:[NSIndexSet class] defaultValue:[NSIndexSet indexSet]]
                 forKey:PRDefaultsNowPlayingCollapseState];

    [_handlers setValue:[PRDefaults boolHandlersForKey:@"mediaKeys" defaultValue:YES] forKey:PRDefaultsMediaKeys];

    [_handlers setValue:[PRDefaults floatHandlersForKey:@"volume" max:1.0f min:0.0f defaultValue:1.0f] forKey:PRDefaultsVolume];
    [_handlers setValue:[PRDefaults floatHandlersForKey:@"preGain" max:1.0f min:0.0f defaultValue:1.0f] forKey:PRDefaultsPregain];
    [_handlers setValue:[PRDefaults boolHandlersForKey:@"hogOutput" defaultValue:NO] forKey:PRDefaultsHogOutput];

    [_handlers setValue:[PRDefaults boolHandlersForKey:@"repeat" defaultValue:NO] forKey:PRDefaultsRepeat];
    [_handlers setValue:[PRDefaults boolHandlersForKey:@"shuffle" defaultValue:NO] forKey:PRDefaultsShuffle];
    
    [_handlers setValue:[PRDefaults EQCustomArrayHandlersForKey:@"CustomEQs"] forKey:PRDefaultsEQCustomArray];
    [_handlers setValue:[PRDefaults boolHandlersForKey:@"isCustomEQ" defaultValue:NO] forKey:PRDefaultsEQIsCustom];
    [_handlers setValue:[PRDefaults intHandlersForKey:@"EQIndex" max:0 min:0 defaultValue:0] forKey:PRDefaultsEQIndex];
    [_handlers setValue:[PRDefaults boolHandlersForKey:@"EQIsEnabled" defaultValue:NO] forKey:PRDefaultsEQEnabled];
    return self;
}

+ (id)sharedDefaults {
    return [PRDefaults sharedDefaults];
}

#pragma mark - Accessors

- (id)valueForKey:(NSString *)key {
    return ((PRDefaultsGetter)[[_handlers objectForKey:key] objectAtIndex:0])();
}

- (void)setValue:(id)value forKey:(NSString *)key {
    ((PRDefaultsSetter)[[_handlers objectForKey:key] objectAtIndex:1])(value);
}
...
- (void)setKeyMask:(unsigned int)mask keyCode:(int)code forHotKey:(int)hotKey {
    for (NSDictionary *i in [PRDefaults hotKeys]) {
